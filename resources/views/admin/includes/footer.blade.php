<footer class="main-footer">
  ...
  <strong>Copyright &copy; {{Session::get('CompanyName')}}</strong> All rights
  reserved .
</footer>
...
<script>
  ...
  $(function() {
    $('#AllEmployees_Table_Id').DataTable()
  })


  var LoggedIn_User = (JSON.parse(sessionStorage.getItem('LoggedIn_User')));
  console.log(LoggedIn_User)
  document.getElementById('LoggedIn_User_Img').src = LoggedIn_User.ProfilePic;
  document.getElementById('LoggedIn_UserName').innerText = LoggedIn_User.name;
</script>